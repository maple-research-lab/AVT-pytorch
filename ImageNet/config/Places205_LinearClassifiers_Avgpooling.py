...
net_opt_cls = [None] * 5
net_opt_cls[0] = {'pool_type':'avg', 'nChannels':64, 'pool_size':12, 'num_classes': 205}
net_opt_cls[1] = {'pool_type':'avg', 'nChannels':192, 'pool_size':7, 'num_classes': 205}
net_opt_cls[2] = {'pool_type':'avg', 'nChannels':384, 'pool_size':5, 'num_classes': 205}
net_opt_cls[3] = {'pool_type':'avg', 'nChannels':256, 'pool_size':6, 'num_classes': 205}
net_opt_cls[4] = {'pool_type':'avg', 'nChannels':256, 'pool_size':6, 'num_classes': 205}
