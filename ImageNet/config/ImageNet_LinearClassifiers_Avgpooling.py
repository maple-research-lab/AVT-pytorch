...
pretrained = './experiments/ImageNet_Unsupervised/model_net_epoch400'
networks['feat_extractor'] = {'def_file': 'architectures/AlexNet.py', 'pretrained': pretrained, 'opt': {'num_classes': 8},  'optim_params': None} 

net_opt_cls = [None] * 5
net_opt_cls[0] = {'pool_type':'avg', 'nChannels':64, 'pool_size':12, 'num_classes': 1000}
net_opt_cls[1] = {'pool_type':'avg', 'nChannels':192, 'pool_size':7, 'num_classes': 1000}
net_opt_cls[2] = {'pool_type':'avg', 'nChannels':384, 'pool_size':5, 'num_classes': 1000}
net_opt_cls[3] = {'pool_type':'avg', 'nChannels':256, 'pool_size':6, 'num_classes': 1000}
net_opt_cls[4] = {'pool_type':'avg', 'nChannels':256, 'pool_size':6, 'num_classes': 1000}
